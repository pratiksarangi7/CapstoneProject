        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Documents_Users_CurrentApproverUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForwardedToDepartmentId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalActions_Departments_ForwardedToDepartmentId",
                        column: x => x.ForwardedToDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalActions_DocumentVersions_DocumentVersionId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalActions_Users_ApproverUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentVersionId = table.Column<int>(type: "integer", nullable: true),
                    Action = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_DocumentVersions_DocumentVersionId",
                        column: x => x.DocumentVersionId,
                        principalTable: "DocumentVersions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_ApproverUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_DocumentVersionId",
                table: "ApprovalActions",
                column: "DocumentVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_ForwardedToDepartmentId",
                table: "ApprovalActions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_DocumentVersionId",
                table: "AuditLogs",
                column: "DocumentVersionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_CurrentApproverUserId",
                table: "Documents",
